    ...
    <div v-else class="comparison-grid">
      <article class="source-card domestic-card">
        ...
        <p v-else class="muted">
          {{ sideEffects?.domestic?.message || '현재 정보를 불러올 수 없습니다.' }}
        </p>
      </article>
      ...
      <article class="source-card overseas-card">
        ...
        <p v-else class="muted">
          {{ sideEffects?.overseas?.message || '현재 정보를 불러올 수 없습니다.' }}
        </p>
      </article>
    </div>

    <aside
      v-if="sideEffects?.disclaimer"
      class="faers-notice"
      aria-label="FAERS 데이터 해석 유의사항"
    >
