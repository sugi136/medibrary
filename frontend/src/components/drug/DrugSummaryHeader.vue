...
.favorite-button { width: 48px; height: 48px; margin-left: auto; border: 1px solid var(--line); border-radius: 15px; color: var(--muted); background: #fff; font-size: 29px; line-height: 1; }
.favorite-button.active { border-color: #f4c5cc; color: var(--danger); background: var(--danger-soft); }
@media (max-width: 600px) { .summary-card { align-items: flex-start; gap: 14px; padding: 20px; }.detail-pill { width: 64px; height: 64px; border-radius: 18px; font-size: 27px; }.summary-text h1 { font-size: 21px; }.favorite-button { width: 40px; height: 40px; font-size: 25px; } }
</style>
